...
class Transformer(nn.Module):
    def __init__(self, input_size=9, output_size=3, d_model=512, n_head=8,
        ...
        self.generator = PositionwiseFeedForward(d_model=d_model, d_model_1=output_size, hidden=ffn_hidden, drop_prob=drop_prob).to(self.device)
